...
export function projectWithPositions(
  ...
  return suggestions.map((suggestion) => {
    ...
    const uiSuggestion = Object.create(Object.getPrototypeOf(suggestion));
    Object.assign(uiSuggestion, suggestion, {
      selectionStart: positions ? positions.start : 0,
      selectionEnd: positions ? positions.end : 0,
    });
    ...
    if (currentDecorations) {
      const newDecorations = DecorationSet.create(
        ...
        currentDecorations.find().filter((decoration: Decoration) => {
          return decoration.spec.suggestionId !== suggestion.suggestionId;
        }),
      );
